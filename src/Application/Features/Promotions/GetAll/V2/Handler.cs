...
/// </summary>
internal sealed class GetAllPromotionsV2Handler : IHandler<GetAllPromotionsV2Request, GetAllPromotionsV2Response>
{
    ...
    public async Task<ErrorOr<GetAllPromotionsV2Response>> HandleAsync(GetAllPromotionsV2Request request, CancellationToken cancellationToken = default)
    {
        ...
        return new GetAllPromotionsV2Response(response, response.Count);
    }
}