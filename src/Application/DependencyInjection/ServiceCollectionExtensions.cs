...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddHandlers(this IServiceCollection services)
    {
        ...
        services.AddTransient<IHandler<GetAllPromotionsV1Request, GetAllPromotionsV1Response>, GetAllPromotionsV1Handler>();
        services.AddTransient<IHandler<GetAllPromotionsV2Request, GetAllPromotionsV2Response>, GetAllPromotionsV2Handler>();
        services.AddTransient<IHandler<GetPromotionByIdV1Request, GetPromotionByIdV1Response>, GetPromotionByIdV1Handler>();
        return services;
    }
